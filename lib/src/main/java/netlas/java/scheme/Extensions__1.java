...
public class Extensions__1 {
    ...
    private List<SignedCertificateTimestamp> signedCertificateTimestamps = new ArrayList<SignedCertificateTimestamp>();
    ...
    @JsonProperty("signed_certificate_timestamps")
    public void setSignedCertificateTimestamps(List<SignedCertificateTimestamp> signedCertificateTimestamps) {
