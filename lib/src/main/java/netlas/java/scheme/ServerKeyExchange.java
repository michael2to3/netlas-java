...
public class ServerKeyExchange {
    ...
    private List<String> clientToServerCompression;
    @JsonProperty("server_to_client_macs")
    private List<String> serverToClientMacs;
    @JsonProperty("client_to_server_macs")
    private List<String> clientToServerMacs;
    @JsonProperty("cookie")
    ...
    private List<String> clientToServerCiphers;
    @JsonProperty("server_to_client_ciphers")
    private List<String> serverToClientCiphers;
    @JsonProperty("server_to_client_compression")
    private List<String> serverToClientCompression;
